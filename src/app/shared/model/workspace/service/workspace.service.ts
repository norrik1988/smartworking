...
export class WorkSpaceService {
    ...
    edit_Workstation(form: NgForm, id: number) {
        ...
        for (let i = 0; i < this.workspace[0].workstations.length; i++) {
            if (this.workspace[0].workstations[i].id == id) {
                this.workspace[0].workstations[i].user = form.value
            ...
            // })
            console.log(JSON.stringify(this.workspace[0].workstations[i]));
